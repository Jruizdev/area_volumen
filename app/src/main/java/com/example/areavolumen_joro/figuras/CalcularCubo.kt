...
@Composable
fun CalcularCubo (navController: NavController) {
    Column (
        Modifier
            .fillMaxSize()
        ...
        Imagen (R.drawable.cubo, 1f)          // Imagen de la figura

        Spacer (modifier = Modifier.height(20.dp))
        Imagen (R.drawable.area_cubo, 0.6f)   // Imagen de la fórmula de área
        Imagen (R.drawable.vol_cubo, 0.6f)    // Imagen de la fórmula de volumen
        Spacer (modifier = Modifier.height(20.dp))
        ...
        BotonPrimario ("Calcular", true) {
            ...
            // Calcular resultado
            val area = 6 * l.doubleValue.pow(2)
            val volumen = l.doubleValue.pow(3)
